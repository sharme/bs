...
router.post('/create', function(req, res, next) {
    ...
    if(req.body.secret == auth.encrypt(req.body.u_id)) {
        ...
        var createSQL = mysql.format("insert into jk_footsteps(fs_pic,fs_des,fs_from,u_id,fs_bigImg,fs_smallImg,fs_create_time,fs_update_time, fs_status) values(?,?,?,?,?,?,?,?,?)", [req.body.fs_pic, req.body.fs_desc, req.body.fs_from, req.body.u_id, req.body.fs_bigImg, req.body.fs_smallImg, date, date,0]);
